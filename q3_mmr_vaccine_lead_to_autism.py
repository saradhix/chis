...
support_words=['causal', 'measles', 'development','suppress',
               'increase', 'cause','evidence', 'increased','associated',
               'more common','true','side effect','factor','causing','link',
               'develop','autism','exposure','heightened','exhibit','abnormal',
               'autism']
...
def main():
  ...
  test_filename = 'MMRVaccineLeadToAutism_test.txt'
  results_filename = 'results/MMRVaccineLeadToAutism_result.csv'
  ...
  print new_supports
  (true_rel, true_sup) = rel_sup.get_rel_sup('q3_rel.txt', 'q3_sup.txt')

...
def main():
  ...
  filename = 'vitaminC_common_cold_final.txt'
...
def classify_doc(document):
  ...
  synonyms['vitamin']=['this','vitamin','zinc','dose','placebo','grams','intake','fruits and vegetables',' it ', 'antiox','supplement','consumed','mg ', 'reduction','myth']
  synonyms['cold']=['this', 'cold','common cold', 'flu', 'illness','sniffles','immun','sick','throat','nose','effect', 'viral','nausea','diabetes','evidence', 'benefit' ]
